...
<span class="yellow-text">SHIFT+8（单位换算）</span>
。一般仅用于压力和速度的换算。
...
<span class="yellow-text">SHIFT+CALC(SOLVE)</span>后输入变量迭代初值 0，按下 =
即可求解，解得 x = 0。
